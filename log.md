|Commit Name   	|Changes  	|Performance to run 100 sample loops on baseline image    |Cython X (comparison against original sample no GPU)  	|Loop   	|Issues     |Notes/Profile     |
|---	|---	|---	|---    |---	|---    |---    |
